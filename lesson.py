        ...
        if event.event_type == keyboard.KEY_DOWN:
            ...
            if key == 'a':
                ...
                try:
                    ...
                    result_text = f"Result: {num1} + {num2} = {add(num1, num2)}"
            ...
            # Handling Subtraction
                ...
                try:
                    num1 = float(input("        Enter 1st number: "))
                    num2 = float(input("        Enter 2nd number: "))
                    result_text = f"Result: {num1} - {num2} = {subtract(num1, num2)}"
                    print("\n" + result_text.center(50))
                except:
                    print(" [!] Please enter numbers only.".center(50))
                input("\n" + "Press Enter to return to menu...".center(50))
            ...
            # Handling Multiplication
                ...
                try:
                    num1 = float(input("        Enter 1st number: "))
                    num2 = float(input("        Enter 2nd number: "))
                    result_text = f"Result: {num1} x {num2} = {multiplication(num1, num2)}"
                    print("\n" + result_text.center(50))
                except:
                    print(" [!] Please enter numbers only.".center(50))
                input("\n" + "Press Enter to return to menu...".center(50))
            ...
            # Handling Division
                ...
                try:
                    num1 = float(input("        Enter 1st number: "))
                    num2 = float(input("        Enter 2nd number: "))
                    result_text = f"Result: {num1} / {num2} = {division(num1, num2)}"
                    print("\n" + result_text.center(50))
